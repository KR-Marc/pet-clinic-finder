...
const KEYWORD_MAP: Record<string, string[]> = {
  ...
  '復健':      ['復健', '水療', '物理治療', '雷射治療'],
  '中獸醫':    ['中獸醫', '針灸', '中藥'],
  '內科':      ['內科', '一般內科', '食慾不振', '嘔吐', '腸胃', '消化道', '感染性疾病'],
  '內分泌科':  ['內分泌', '糖尿病', '甲狀腺', '荷爾蒙', '腎上腺'],
  '呼吸科':    ['呼吸科', '胸腔', '氣管', '支氣管', '肺臟', '呼吸道'],
  '影像診斷':  ['X光', '超音波', 'CT', 'MRI', '電腦斷層', '磁振造影', '影像診斷'],
  '安寧照護':  ['安寧', '緩和', '臨終', '疼痛管理', '安寧照護', '居家安寧'],
  '行為醫學':  ['行為醫學', '行為門診', '分離焦慮', '攻擊行為', '行為治療'],
  '健檢':      ['健康檢查', '年度健檢', '預防醫學', '疫苗', '健檢套餐'],
}
