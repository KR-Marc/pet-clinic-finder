...
async function fetchClinics(q: string, pet: string, district: string): Promise<Clinic[]> {
  ...
  const tagSetsPerTerm: Set<string>[] = queryTerms.map((term) => {
    ...
    const ALIAS: Record<string, string> = {
      ...
      '結紮': '外科', '絕育': '外科', '手術': '外科', '切除': '外科', '縫合': '外科',
      '健康檢查': '健檢', '健檢': '外科', '預防': '外科',
      '內科': '外科', '呼吸': '心臟科',
      // 急診緊急
      '狂犬病': '24H急診', '傳染': '24H急診', '中毒': '24H急診', '昏迷': '24H急診',
      '休克': '24H急診', '大量出血': '24H急診', '骨折': '24H急診', '車禍': '24H急診',
      ...
      '過敏': '皮膚科', '濕疹': '皮膚科', '皮屑': '皮膚科', '脫毛': '皮膚科',
      '搔癢': '皮膚科', '一直抓': '皮膚科', '紅疹': '皮膚科',
      // 腸胃
      '嘔吐': '外科', '腹瀉': '外科', '拉肚子': '外科', '腸胃炎': '外科',
      '胰臟': '外科', '胃扭轉': '24H急診', '便秘': '外科', '血便': '外科',
      // 泌尿/腎臟
      '血尿': '泌尿科', '頻尿': '泌尿科', '尿結石': '泌尿科', '膀胱': '泌尿科',
      '腎臟': '腎臟科', '腎衰竭': '腎臟科', '腎病': '腎臟科', '多喝水': '腎臟科',
      // 口腔牙齒
      '口臭': '牙科', '牙結石': '牙科', '牙周': '牙科', '牙齦': '牙科',
      '掉牙': '牙科', '洗牙': '牙科', '口腔': '牙科', '流口水': '牙科',
      // 眼睛
      '眼屎': '眼科', '眼睛': '眼科', '白內障': '眼科', '眼睛紅': '眼科',
      '眼睛腫': '眼科', '眼分泌物': '眼科', '角膜': '眼科',
      // 心臟呼吸
      '心臟': '心臟科', '咳嗽': '心臟科', '喘': '心臟科', '呼吸困難': '24H急診',
      '心雜音': '心臟科', '心跳': '心臟科', '肺': '心臟科',
      // 骨科/關節
      '跛行': '骨科', '關節': '骨科', '骨骼': '骨科', '椎間盤': '骨科',
      '後肢無力': '骨科', '走路歪': '神經外科', '髖關節': '骨科',
      // 神經
      ...
      '多喝多尿': '腎臟科', '體重下降': '外科',
      // 外科手術
      '結紮': '外科', '絕育': '外科', '手術': '外科', '切除': '外科',
      '縫合': '外科', '傷口': '外科', '術後': '復健',
      // 老年/復健
      '老犬': '復健', '老貓': '復健', '關節退化': '復健', '復健': '復健',
      '針灸': '中獸醫', '中藥': '中獸醫', '中獸醫': '中獸醫',
      // 急診關鍵詞
      '急診': '24H急診', '半夜': '24H急診', '緊急': '24H急診', '24小時': '24H急診',
      '無法排尿': '24H急診', '不吃不喝': '24H急診',
    }
