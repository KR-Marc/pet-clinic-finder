...
const GUIDES = [
  ...
  },
  {
    specialty: '行為門診',
    icon: 'brain',
    description: '行為問題常被誤以為是個性，實際上多與焦慮、疼痛或環境壓力有關，可透過專業評估改善。',
    symptoms: ['分離焦慮', '攻擊行為', '過度舔毛', '亂尿尿', '異常吠叫', '怕雷怕鞭炮'],
    diseases: ['分離焦慮症', '強迫行為', '貓特發性膀胱炎', '老年認知功能障礙'],
    when_to_visit: '行為突然改變、自我傷害（過度舔毛掉毛）、攻擊家人或其他寵物、無法獨處',
    cost: '行為門診初診約 1,500–3,000 元，行為矯正療程依個案差異較大',
    q: '行為門診',
    breeds: { cat: ['暹羅貓', '緬甸貓（高敏感、易焦慮）', '東方短毛貓'], dog: ['邊境牧羊犬', '德國牧羊犬', '吉娃娃', '玩具貴賓（分離焦慮高風險）'] },
  },
  {
    specialty: '24H急診',
    icon: 'siren',
